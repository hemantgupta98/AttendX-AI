  ...
  return (
    <div className="min-h-screen bg-[#f2f2f2] p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="flex flex-col justify-between gap-5 rounded-3xl bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500 p-8 text-white shadow-xl md:flex-row md:items-center">
          <div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="mt-10">
            ...
            <div className="h-4 overflow-hidden rounded-full bg-slate-200">
              <div
                className="h-full rounded-full bg-gradient-to-r from-green-500 to-blue-600 transition-all duration-700"
                style={{
