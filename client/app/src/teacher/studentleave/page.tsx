...
const EmployeeLeaveRequests = () => {
  ...
  const fetchLeaves = async () => {
    try {
      ...
      const res = await axios.get(
        "https://attendx-ai-n8uq.onrender.com/api/student/leave/employee/getLeaves",
        {
  ...
  const handleStatusChange = async (id: string, status: LeaveStatus) => {
    ...
    try {
      await axios.patch(
        `https://attendx-ai-n8uq.onrender.com/api/student/leave/update/${id}`,
        {
          status,
        },
        {
    ...
    <main className="min-h-screen bg-[#f6f8fc] p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-slate-500">
          View, search, and manage all student leave requests.
        </p>
      </div>
