          ...
          <section className="grid w-full gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur xl:p-8">
                  ...
                  <p className="mt-2 text-gray-600">
                    {matched ? (
                      ...
                      <>
                        ...
                        <br />
                        This attendance attempt has been recorded as{" "}
                        <b>Absent</b>. Please try again with proper lighting and
              ...
              <div className="mb-6 space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600 sm:text-base">
                    ...
                    centered, and capture a professional image that can be
                    matched with your registered employee photo.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-amber-900">
                ...
                uploaded image. After a successful match, the capture will be
                used to mark your attendance. Please keep the image clean,
            ...
            <aside className="rounded-3xl border border-slate-200 bg-slate-950 p-4 shadow-[0_20px_60px_rgba(15,23,42,0.18)] sm:p-5">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-2xl bg-white/5 p-4 text-sm text-slate-200">
                  ...
                  <p className="mt-2 leading-6">
                    The captured image will be matched with your registered
                    photo before attendance is submitted.
                  </p>
                </div>
              </div>
